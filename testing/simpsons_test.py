...
def test_homer():
    ...
    assert homer("doughnuts") == "DOUGHNUTS!"

def test_homer_salad():
    assert homer("salad") == "You don't win friends with salad"

def test_homer_default():
    assert homer() == "You don't win friends with salad"
