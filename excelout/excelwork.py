...
def get_ip_data():
    ...
    key3 = input("What other key would you like to add? ")
    value3 = input(f"What value would you like to assign to {key3}? ")
    key4 = input("What other key would you like to add? ")
    value4 = input(f"What value would you like to assign to {key4}? ")
    d = {"IP": input_ip, "driver": input_driver, key3: value3, key4: value4}
    return d
